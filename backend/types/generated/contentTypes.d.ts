...
export interface ApiBusinessPageBusinessPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    wlc: Schema.Attribute.Component<'components.description-hp', false>;
  };
}
...
export interface ApiCompanyPageCompanyPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    cards: Schema.Attribute.Component<'components.cards', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    img: Schema.Attribute.Component<'components.slider', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiEshopEshop extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::eshop.eshop'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    secondContainer: Schema.Attribute.Component<
      'components.seccond-conatiner-hp',
      true
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
